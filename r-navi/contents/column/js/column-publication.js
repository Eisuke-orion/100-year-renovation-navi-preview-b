...
(() => {
  const articles = Object.freeze([
    ...
    { episode: 12, file: "column-12.dc.html", title: "変動金利の「1％」で家計はどう変わる？", publishDate: "2026-09-22", related: [1, 2, 7, 11] },
    ...
    { episode: 17, file: "column-17.dc.html", title: "住まいの相談に生成AIをどう使う？──今日から試せる4つの活用法", publishDate: "2026-10-08", related: [1, 2, 7, 19] },
    { episode: 18, file: "column-18.dc.html", title: "熊本地震後、6避難所の調査で多かった困りごとは「トイレ」──被災地の教訓から、今日備えること", publishDate: "2026-10-13", related: [1, 2, 9, 13] },
